...
def test_debug_version_exposes_realpath_build_marker():
    ...
    assert data["front_door_release"] == "deferred-setup-claim-v1"
...
def test_phone_tap_talk_waits_for_cached_medicine_matcher_before_first_use():
    ...
    for medicine in ["Panadol", "Glucose", "ORS", "Paracetamol", "Amoxyl", "Cetirizine", "Belladonna"]:
        assert f'"{medicine}"' in script
