...
def test_offline_app_routes_return_html():
    ...
    assert "PHARMAREEN REAL PATH BUILD pharmareen-phone-ready-v2026-05-31" in followed_response.text
    ...
    assert compat_response.headers.get("x-pharmareen-offline-version") == "pharmareen-phone-ready-v2026-05-31"
...
def test_debug_version_exposes_realpath_build_marker():
    ...
    data = response.json()
    assert data["offline_build_version"] == "pharmareen-phone-ready-v2026-05-31"
...
def test_debug_offline_app_reports_all_phase6_features(monkeypatch, tmp_path):
    ...
    assert data["frontend_marker"] == "PHARMAREEN REAL PATH BUILD pharmareen-phone-ready-v2026-05-31"
...
def test_legacy_local_offline_app_matches_phase6_frontend():
    ...
    assert "PHARMAREEN REAL PATH BUILD pharmareen-phone-ready-v2026-05-31" in legacy_html
...
def test_offline_pwa_assets_contain_auto_sync_media_and_retry_logic():
    ...
    assert "PHARMAREEN REAL PATH BUILD pharmareen-phone-ready-v2026-05-31" in html
