...
The first MS2-LT-055 attempt failed at its entry point: owner evidence showed completed Sale 1 (Ibuprofen x6 Cash, stock left 21), but the receipt was inert text; tap did nothing and long-press opened Android text selection. This is a product failure. The shared receipt root now makes every completed numbered sale an explicit `Tap to open sale` button backed by its stable transaction reference. The opened detail shows original sale facts and clear Refund, Return and Credit actions. Each action opens one linked, non-mutating adjustment review with exact one-item financial and stock consequences; no confirmation path is exposed during this focused repair checkpoint, and the original sale remains intact. After deployment, repeat MS2-LT-055 from the beginning: create one controlled completed sale, tap its receipt, choose **Return** once, and stop at the linked review. Require the original Sale number, medicine, sold quantity, one-item return quantity, unit price, refund amount, stock-to-restore quantity, original completed status and explicit no-change wording. Do not confirm or try Refund/Credit in this retest.
