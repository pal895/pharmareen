...
5. **Original 055-E — partial/full and repeat safety:** **NEXT — PREPARED FOR OWNER TEST.** On a multi-quantity sale, confirm one partial adjustment, verify the displayed previously-adjusted and remaining quantities, finish the remainder, and prove over-adjustment/double confirmation is blocked without a second stock or financial effect. Quantity controls disable at their safe bounds and a fully adjusted sale produces an explicit no-change message.
