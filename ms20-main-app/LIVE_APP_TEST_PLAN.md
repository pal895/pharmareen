...
4. **Original 055-D — Credit:** use a fresh sale, confirm Credit, verify account-credit wording, no false cash/M-Pesa refund and no stock restoration.
5. **Original 055-E — partial/full and repeat safety:** on a multi-quantity sale, confirm one partial adjustment, verify the remaining quantity, finish the remainder, and prove over-adjustment/double confirmation is blocked without a second stock or financial effect.
