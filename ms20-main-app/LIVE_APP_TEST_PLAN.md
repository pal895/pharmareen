...
3. **Original 055-C — Refund with returned stock:** use a fresh sale, explicitly select `Money + returned stock`, confirm, verify the linked Refund record and exact one-unit catalog restoration.
