...
Permanent test priority: **Voice first → fast tap/action second → typing last**. When a supported operational route is available through device/platform speech, live-test instructions must exercise voice first and use typing only for fallback/parity. Voice transcripts and typed input must converge on the same deterministic router and produce equivalent workflow results without AI or a separate voice-only business path. Exceptions are accessibility, noisy environments, unsupported voice, offline phone speech limitations, correction of misheard text and deliberate owner fallback. Common workflows remain three steps or fewer unless repository evidence requires otherwise.
...
The first MS2-LT-055 attempt failed at its entry point: owner evidence showed completed Sale 1 (Ibuprofen x6 Cash, stock left 21), but the receipt was inert text. The first repair made receipts discoverable and owner evidence then proved Sale 2 opened correctly and reached a truthful Return review, but exposed a second root dead-end: review had only Cancel. The shared Sale Adjustment engine now completes Return, Refund and Credit through one deterministic review/confirm boundary. It enforces remaining quantity, permanent original linkage, idempotent confirmation, local adjustment-ledger persistence and offline sync queueing. Return restores proportional base stock and reverses the original payment value; Refund requires an explicit money-only or money-plus-stock choice; Credit creates account credit without claiming a cash/M-Pesa refund or restoring stock. Completed adjustment receipts and original-sale details navigate reciprocally. The original sale is immutable and the protected Production Sales Card is unchanged. Repeat only MS2-LT-055: create and confirm Ibuprofen 1 tablet Cash, open its receipt, choose Return, verify the review, confirm Return, then capture the completed Return receipt and its linked original sale.

MS2-LT-055 remains one repository-controlled checkpoint with two strictly ordered programmes. The original programme must finish before the approved direct-command addition begins, and every case pauses for owner screenshots:

1. **Original 055-A — full Return:** OWNER-VERIFIED PASSED on 2026-07-31. Sale 3 recorded Ibuprofen 1 tablet Cash at stock 20 → 19; its openable receipt resolved the immutable completed sale; Return review showed quantity 1, KES 18 reversal and stock restore 1; Confirm created Return 1; reciprocal navigation linked Return 1 and Sale 3; the catalog independently showed restored stock 20.
2. **Original 055-B — Refund, money only:** OWNER-VERIFIED PASSED on 2026-07-31. The corrected Sale 5 case recorded Ibuprofen x1 Cash at stock 19 → 18; the selected Money-only choice was unmistakably green/checkmarked; the review used simple stock wording and showed Money back KES 18 / Stock added back 0; confirmation produced `Refund for Sale 5` with secondary `Refund record #3`; immutable linkage remained correct and stock stayed at the post-sale value. Do not repeat 055-B. The owner separately identified long-term presentation improvements—restore compact side-by-side choices while retaining selection feedback, replace accumulating adjustment receipts with one Latest Adjustment card plus complete Adjustment History, and generalize the same singleton/latest-plus-history contract to Catalog Activity, Export and future system statuses. Per the mandatory order, record these for implementation and dedicated owner tests only after original 055-C through 055-F pass.
3. **Original 055-C — Refund with returned stock:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED** on 2026-08-01. Sale 2 recorded Ibuprofen x1 Cash and reduced stock 17 → 16. The owner selected the clearly green/checkmarked `Money back + medicine back in stock`; review showed Money back KES 18, Stock added back 1, Cash reversal and original completed. Confirm created Refund record #5 linked reciprocally to immutable completed Sale 2. Exactly one tablet was restored and the catalog independently returned to 17, with no duplicate or incorrect stock effect. Do not repeat 055-C.
4. **Original 055-D — Credit:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED** on 2026-08-01. Sale 3 recorded Ibuprofen x1 Cash and reduced stock 17 → 16. Credit review and Credit record #6 created exactly KES 18 account credit, made no cash refund and restored zero stock. Immutable Sale 3 linked reciprocally to the confirmed Credit record, catalog stock remained 16 and no duplicate accounting effect occurred. Do not repeat 055-D.
5. **Original 055-E — partial/full and repeat safety:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED** on 2026-08-02. Earlier evidence proved Sale 4 x3 Cash, stock 16 → 13, Return record #7 for 1/KES 18/stock 1, Return record #8 for 2/KES 36/stock 2, immutable reciprocal links and final catalog stock 16. The focused retest proves the sale detail now renders `This sale has already been fully adjusted. No stock or money changed.`, blocks all three Return/Refund/Credit entry points before review, leaves repeated taps inert, retains linked records #7 and #8, creates no review or new record, and leaves Ibuprofen stock at 16 with no stock or money change. Repeated 16:07 protection messages visible in the conversation are historical outputs from the earlier test before the controls were disabled; they are not new retest effects and do not authorize a duplicate-message UX change. Do not repeat Sale 4 or its split returns. 055-F remains next but has not begun.
6. **Original 055-F — offline persistence/retry:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED** on 2026-08-02. Owner screenshots prove one new Ibuprofen x1 Cash sale recorded online at stock 16 → 15; Sale 1 remained completed and immutable. With the app visibly offline, its Return review showed quantity 1, previously adjusted 0, remaining 1 → 0, KES 18 reversed against Cash and stock +1, then Confirm created permanent Return record #9 locally. Return #9 linked to Sale 1, Sale 1 linked back to exactly that one Return, the fully-adjusted boundary appeared, and the catalog independently returned to stock 16. After reconnecting, one Sync operation processed the device backlog and reduced queue 53 → 0; the same Return #9, links and stock 16 remained with no duplicate money or stock effect. The 53-item count was historical pending device work, not work created by this test, and does not reopen 055-F. Do not repeat this test.

Original 055-A through 055-F are complete, owner-verified and protected. The checkpoint itself remains open while the approved addition is implemented and tested last. That addition retains the tappable route and adds one deterministic, pharmacy-local, offline-first typed/microphone parser for `open|return|refund|credit|undo sale N` and `open|return|refund|undo last sale`. Its ordered owner cases are: open by number; Return routing; confirmed direct Return; Refund routing; Credit routing; safe linked undo (never deletion); last-sale resolution; typed and microphone parity; invalid/incomplete/already-adjusted/ambiguous safety. Each case is separate and screenshot-gated. MS2-LT-055 becomes OWNER-VERIFIED PASSED / FROZEN / PROTECTED only after both programmes pass without unresolved friction.

The exact next owner case is **Direct Command 1 — typed open by sale number**. The deterministic parser accepts only the complete shape `open sale N`, resolves only an existing completed sale through `completedSaleByReference()`, and opens the unchanged shared completed-sale detail card. Missing sale numbers fail read-only with `Nothing changed.` Return, Refund, Credit, Undo, last-sale and microphone execution remain disabled until their ordered cases. Owner-test only `open sale 1` against the existing 055-F Sale 1; verify the immutable sale facts, Return #9 linkage, fully-adjusted protection and no stock/financial mutation, then stop for screenshots.

The first owner attempt failed before sale navigation: microphone recognition produced `open cell one`, and the voice handler bypassed the typed-only priority parser, so medicine fallback opened an unsaved `Open sale` onboarding card. Nothing was confirmed or saved. The root repair now routes both typed and microphone transcripts through one shared command-priority boundary before stock/catalog/medicine parsing. That grammar recognizes `open sale N`, shorthand `sale N`, and bounded speech normalization such as `open cell one`; ordinary medicine text still falls through unchanged. Restart Direct Command 1 from the beginning with the focused typed regression `open sale 1`, `open sale 4`, `sale 1`; no adjustment action is enabled.

The second owner attempt proves parser priority and ordinary medicine fallback are repaired, but is an early lookup **FAIL**: all three sale commands produced safe false-not-found responses. Root cause was a divergent command-only precheck against transient `state.transactions`; receipt and adjustment-link navigation use `openCompletedSale()` over the persisted Transaction Completion Engine ledger. Direct navigation now delegates immediately to that same authoritative function. Its established unqualified-number collision rule selects the latest persisted completed, non-reversed sale in ledger order; a stable transaction ID from receipts/links remains exact. No transaction, numbering, adjustment, stock, finance, queue or medicine behavior changed. Restart only Direct Command 1.
...
**MS2-LT-055-H / Direct Command 2 — Return routing only:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-02.** Voice `ibuprofen one tablet cash` opened the ordinary Sale Review for one Ibuprofen tablet at KES 18 Cash with stock 16 → 15; one confirmation created completed Sale 2. Voice `return sale 2` then routed through the shared deterministic voice/typed priority router and persisted immutable-sale resolver directly to the existing Return review. The review truthfully showed quantity 1, previously adjusted 0, remaining 1 → 0, KES 18 money back, stock +1, Cash reversal and the original sale completed. Confirm Return was not tapped; the visible review-only protection confirmed no edit or deletion, and no adjustment, stock, money or queue mutation occurred. No typing or manual lookup was required. Do not repeat 055-H without verified regression. The owner subsequently authorized preparation of the next ordered case.

**MS2-LT-055-I / Direct Command 3 — Confirmed Direct Return:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-02.** The first microphone attempt was transcribed by the phone as `return cell to`; it caused no sale, stock, money, adjustment or queue mutation and remains a recognition observation only. Do not weaken deterministic grammar with broad `cell`-to-`sale` matching. The corrected voice transcript `return sale 2` reopened the correct shared Return review, and one Confirm Return tap created exactly Return record #10 through the protected shared adjustment engine. Return #10 records Ibuprofen x1 tablet, KES 18 reversed against Cash, stock +1, confirmed status and Owner staff; it links reciprocally with immutable completed Sale 2. Sale 2 preserves quantity 1, KES 18 Cash and historical stock after sale 15, shows remaining 0/full-adjustment protection, and disables Refund/Return/Credit. Catalog stock is exactly 16, with no duplicate record, stock restoration, financial reversal or queue effect. Do not repeat 055-I without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-J / Direct Command 4 — Refund routing only:** this is the only active owner case. First use the Mic to create and confirm one ordinary `Ibuprofen one tablet cash` sale; note its displayed Sale number. Then use the Mic and say `Refund sale [number]`. Verify the existing shared Refund review opens for that immutable completed sale with quantity 1, previously adjusted 0, remaining 1 → 0, KES 18 money back, stock added back 0 by the default Money only choice, Cash reversal, original sale completed and the explicit review-only/no-change message. Do not confirm the Refund. Capture the completed sale receipt and full Refund review, then stop. Typing is fallback only if voice is unavailable and must be recorded. No Refund record, stock restoration, financial reversal or queue mutation is permitted in this case.

The first owner attempt failed safely before review because the live app served the pre-`2e2abaa` router and emitted its old `Refund by command is not enabled yet. Nothing changed.` fallback after correctly transcribing `refund sale 3`. Sale 3 was created, but no Refund review, adjustment, stock, money or queue mutation occurred. Pushed `2e2abaa` already connects exact Refund commands to the shared persisted-sale/Refund-review roots and passes the focused verifier, so no duplicate source repair is authorized. Deploy and verify the latest revision, then restart only 055-J from the beginning with a fresh sale and the same review-only stop boundary.

The second owner attempt reached the current dispatcher but failed safely before Refund review because `refund sale number four` included the deterministic filler word `number`, which the shared parser did not yet accept. The transcript therefore fell through to ordinary medicine parsing and opened an unconfirmed Sales card for `refund sale number`, quantity 4; no sale from that card, Refund, stock, money or queue mutation occurred. The root fix adds only optional literal `number` to the shared sale-command grammar and protects `refund sale 4`, `refund sale four`, `refund sale number 4` and `refund sale number four` through the priority boundary. Incomplete, medicine-shaped and Refund/Return `cell` forms remain non-commands. Deploy the new revision and restart only 055-J with a fresh sale; retain the review-only stop boundary.

The corrected owner retest passes and freezes **MS2-LT-055-J / Direct Command 4**. On deployed `682f7ca`, voice `refund sale number four` opened the shared Refund Sale 4 review before medicine parsing. It showed Ibuprofen tablet x1, previously adjusted 0, remaining 1 → 0, KES 18 money back, selected Money only, stock +0, Cash reversal and immutable completed original sale, with the stock-restoring alternative still available. Confirm Refund was not tapped and the review-only notice proved no Refund record, stock, financial or queue mutation. Protect all four exact numeric/spoken and optional-`number` variants plus rejection of incomplete/unsafe lookalikes. Do not repeat 055-J without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-K / Direct Command 5 — Credit routing only:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-03.** Voice-first setup created fresh Ibuprofen x1 Cash Sale 1 at stock 14 → 13. Voice `credit sale number one` routed before medicine parsing through the shared priority boundary and persisted immutable-sale resolver to the existing Credit review. The review showed quantity 1, previously adjusted 0, remaining 1 → 0, account credit KES 18, stock +0, `Create KES 18 account credit; no cash refund`, immutable completed original sale and the explicit no-change notice. Confirm Credit was not tapped, so no Credit record, stock, cash-refund, financial-posting or queue mutation occurred. Do not repeat 055-K without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-L / Direct Command 6 — Safe linked Undo:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-03.** Fresh Ibuprofen x1 Cash Sale 2 reduced stock 13 → 12. Phone speech repeatedly heard `cell` instead of `sale`, so the owner used the protected typing fallback. The deterministic command opened the correct non-mutating review; one Confirm Undo created exactly one linked reversal, retained immutable completed Sale 2, reversed KES 18, restored one tablet, blocked Refund/Return/Credit and exposed the linked Undo. Independent catalog evidence confirmed stock exactly 13. No duplicate reversal, stock or money effect occurred. Do not repeat 055-L without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-M / Direct Command 7 — Last-sale resolution:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-03.** Voice `Open last sale` opened latest persisted immutable Sale 2 with Ibuprofen x1 tablet, KES 18 Cash, historical stock 12, completed status, one linked Undo and blocked adjustments. Independent catalog stock remained 13. The post-command Menu showed Queue 7; absent a pre-command screenshot, this is recorded as existing device backlog because the read-only route has no queue write and no new sale, adjustment, reversal, stock or money effect appeared. Protect approved open/return/refund/undo last-sale forms through the shared resolver; Credit last-sale remains unsupported. Do not repeat 055-M without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-N / Direct Command 8 — Typed and Microphone parity:** **OWNER-VERIFIED PASSED / FROZEN / PROTECTED on 2026-08-03.** Microphone `open sale 2` and typed `Open sale 2` both reached the shared deterministic priority router and displayed the identical immutable completed Sale 2: Ibuprofen x1 tablet, KES 18 Cash, historical stock 12, one linked Undo and blocked Refund/Return/Credit. Catalog stock remained 13 and Queue remained 7 before and after. No sale, adjustment, reversal, stock, money or queue mutation occurred. Do not repeat 055-N without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-055-O / Direct Command 9 — Safe errors:** this is the only active owner case. Do not create a sale. Capture baseline Ibuprofen stock 13 and Queue 7. Use Mic for each command separately: `refund sale number`, `return cell two`, `open sale 999`, then `return sale 2`. The first two must show the safe response `I could not safely identify one completed sale from that command. Nothing changed.` and must not open a medicine sales card. The nonexistent sale must show the local-history not-found/no-change response. The already-adjusted Sale 2 must remain completed with its linked Undo and blocked adjustment controls; no adjustment review or confirmation may become available. Confirm final stock remains 13 and Queue remains 7. Do not tap any adjustment or confirmation. Stop with screenshots of the four transcripts/results and final stock/queue.

The first owner run passed the first three safe-error commands and preserved stock 13/Queue 7, but `return sale 2` incorrectly opened an actionable Return review despite Sale 2's linked Undo. No confirmation or mutation occurred. The root repair moves stable linked-Undo eligibility into the shared adjustment-entry boundary, covering both runtime and permanent transaction identities. After deploying the repair, retest only Mic `return sale 2`. It must show immutable completed Sale 2, its linked Undo, blocked Refund/Return/Credit and the no-further-stock-or-money message; it must not open a Return review. Reconfirm stock 13 and Queue 7, then stop.

The focused retest passes and freezes **MS2-LT-055-O / Direct Command 9**. Voice-routed `return sale 2` displayed immutable completed Sale 2, its linked Undo, blocked Refund/Return/Credit and the no-further-stock-or-money message without opening a Return review. Catalog stock remained 13 and Queue remained 7. Together with the earlier safe interception of `refund sale number` and `return cell 2`, and read-only rejection of `open sale 999`, the case produced no sale, adjustment, reversal, stock, money or queue mutation. Original 055-A through 055-F and direct-command 055-G through 055-O are OWNER-VERIFIED PASSED/FROZEN/PROTECTED; checkpoint 55 is complete and protected. Do not repeat 055-O without verified regression. No later case is active until explicit owner authorization.

**MS2-LT-056-A — Existing linked-Undo reconciliation:** this is the only active owner case. Do not create a sale. Capture baseline Ibuprofen stock 13 and Queue 7. Use Mic `open sale 2`. The immutable completed Sale 2 detail must retain Ibuprofen x1 tablet, KES 18 Cash, historical stock 12, linked Undo and blocked adjustments. Its reconciliation summary must show `1 restored once`, `KES 18 reversed once`, `Sale 2 + Undo Sale 2`, `Net KES 0`, and audit facts containing `reversed`, `owner_direct_command` and the recorded time. Close the detail, then confirm catalog stock remains 13 and Queue remains 7. Do not issue Undo, tap an adjustment, sync, or confirm anything. Stop with screenshots of the sale detail/reconciliation summary and final stock/queue.

The first owner attempt failed safely at card presentation. Voice `open cell 2` and corrected `open sale 2` reached the flow, but undefined `summaryGrid()` caused the isolated `Draft could not be displayed` fallback. Stock remained 13 and Queue remained 7; nothing mutated. The focused repair uses the established `saleDetailList()` renderer. After deployment, repeat only Mic `open sale 2` and capture the full five-part reconciliation summary plus final stock 13/Queue 7. No other command or confirmation is authorized.

The corrected retest passes and freezes **MS2-LT-056-A**. Voice `open sale 2` rendered immutable completed Sale 2 with linked Undo, blocked adjustments, stock `1 restored once`, finance `KES 18 reversed once`, receipts `Sale 2 + Undo Sale 2`, report `Net KES 0`, and reversed/owner-direct-command/timestamp audit facts. Independent catalog stock remained 13 and Queue remained 7. No mutation occurred. Checkpoint 56 is OWNER-VERIFIED PASSED/FROZEN/PROTECTED. Do not repeat 056-A without verified regression. No later case is active until explicit owner authorization.
...
### Revised MS2-LT-067-A — Automatic first-owner initialization, repeat sign-in and pharmacy-bound session

Internal prerequisite (not an owner action): the deployment is bound to the exact active test-pharmacy registry ID and the durable owner store is available. Platform administration remains separate and fail-closed, but is not used to initialize or authenticate the owner.

The binding prerequisite is infrastructure-only. Production receives a short-lived signed request-scoped tenant binding from the trusted routing edge populated by provisioning; it never requires per-pharmacy environment variables or pharmacy-ID copying. The isolated one-pharmacy Replit test may infer its sole active registry row, while ambiguity fails closed. No Secrets or Shell configuration counts as an owner action.

Physical evidence after the first scalable-routing deployment found `/main-app/` bypassing owner state and serving the legacy chat home even though bootstrap correctly reported initialization required. The shared entry route and responsive summary layout are repaired. After deployment, repeat only the safe bootstrap preflight, then open `/main-app/` and require direct `Activate first owner` with the resolved pharmacy/owner before entering a PIN. Do not tap through `MS2.0 Assistant` or repeat earlier checkpoints.

The next physical sequence proved first-owner activation and guarded authenticated Main App entry. `Operations setup needed` is a separate business/catalog readiness state and is not owner authentication. Inline Primary Owner PIN rules and Show/Hide controls are now required before the remaining repeat-sign-in proof. Quick PIN and recovery architecture is locked but deferred to its Launch Critical device-trust/recovery dependencies; it is not added to this owner case.

Owner activation is limited to three actions: (1) scan/open the invitation, (2) confirm the named pharmacy and owner and create the PIN, (3) enter the Main App through the automatic transition. Repeat sign-in is limited to three actions: (1) open MS2.0, (2) enter registered phone and private PIN, (3) enter the Main App through the automatic transition. Infrastructure and automatic processing are not owner actions.

The prior admin-secret, operator-invitation and WhatsApp-OTP proposals were withdrawn before owner completion. This is the only active owner case. Before the physical-phone action, verify the safe bootstrap-status response for the exact deployed pharmacy; it exposes only `requires_initialization` and, only when uninitialized, display names. Zero durable credentials for the registry-bound pharmacy must produce activation. Exactly one credential matching both pharmacy ID and normalized registered phone must produce sign-in. Unavailable, duplicate, or mismatched state must return 503 and stop; it must never be presented as sign-in. On the physical phone over HTTPS, open the deployed MS2.0 URL. If uninitialized, confirm only that the displayed pharmacy and owner are correct, create and confirm a private PIN, and tap **Activate and open Main App**. Sign out, reopen MS2.0, enter the registered phone and PIN, and confirm Main App entry. Capture only safe screens: first-owner identity before entering a PIN, post-activation Main App, signed-out sign-in page, and successful repeat Main App. Never capture a PIN, cookie, session value, platform credential or private logs. Automated evidence alone cannot pass the checkpoint.
