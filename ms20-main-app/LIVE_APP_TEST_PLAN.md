...
- Next live checkpoint after deployment: Back to the home screen, open `Payment Queue`, select `Request & Verify`, return to MS2.0, and type `Losartan 1 mpesa` once. Expect `Sale 3 is waiting`, a visible Losartan x1 M-Pesa waiting item, and unchanged Losartan stock 39. Do not resolve the simulated payment until analyzed.
