...
2. **Original 055-B — Refund, money only:** create a fresh one-item Cash sale, open it, choose Refund, explicitly select `Money only`, review, confirm, verify the linked Refund record, and verify catalog stock is not restored.
