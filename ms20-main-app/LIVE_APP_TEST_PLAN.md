...
**MS2-LT-055-N / Direct Command 8 — Typed and Microphone parity:** this is the only active owner case. Do not create a sale. Capture baseline catalog stock 13 and Queue 7. Tap Mic and say `Open sale 2`; capture the resulting completed Sale 2 detail, then close the card. Type `open sale 2` in the composer and Send; capture the resulting detail. Both paths must show the identical immutable Sale 2: Ibuprofen x1 tablet, KES 18 Cash, historical stock 12, completed status, one linked Undo and blocked Refund/Return/Credit. Confirm catalog stock remains 13 and Queue remains 7. Do not issue another command or tap an adjustment. Stop with screenshots of both transcripts/results and final stock/queue.
