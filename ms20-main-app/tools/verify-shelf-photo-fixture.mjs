...
assert(app.includes("await addPhotoCards(file, scanType, visualFixture)"), "Camera and gallery files must converge into the shared photo pipeline");
...
assert(app.includes('if ((scanType === "shelf_photo" || scanType === "medicine_photo") && !visualFixture)'), "Unclear camera photos must stay in the shared retake flow");
