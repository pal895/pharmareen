...
assert(app.includes("function bindActionElements(scope)") && app.includes('event.target.closest?.("[data-action]")'), "All current and dynamically rendered actions must inherit stable delegated interaction");
