...
assert.match(zeroAndMissingDocx, /Stock 0 \| Selling price KES 0 \| Cost price KES Not recorded/);
assert.match(zeroAndMissingDocx, /Expiry Not recorded/);
assert.doesNotMatch(zeroAndMissingDocx, /Supplier |Batch |Shelf |Barcode /);
...
assert.match(decodedPackages.docx, /Add notes or make owner-reviewed changes in Microsoft Word or Google Docs\./);
