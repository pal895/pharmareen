...
class GoogleSheetsFrontDoorStore:
    ...
    def load(self) -> dict[str, Any]:
        state: dict[str, Any] = {"version": 1, "community_counter": 0, "pharmacies": {}, "used_nonces": []}
    ...
    def save(self, value: dict[str, Any]) -> None:
        ...
        rows = [[PLATFORM_ROW, _json({"community_counter": int(payload.get("community_counter") or 0), "used_nonces": list(payload.get("used_nonces") or [])[-10000:]})]]
