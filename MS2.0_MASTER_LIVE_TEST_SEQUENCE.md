...
| 55 | Refunds, returns and credits | Record linked financial/stock adjustments without deleting original history, then validate approved status-card and direct-command improvements without replacing the tappable route. | 51–54 | Implemented — awaiting owner live test | Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-J/Direct Command 4 are owner-verified passed/frozen/protected; 055-J is the latest protected resume point**. The corrected 2026-08-03 voice-first evidence proves `refund sale number four` routed before medicine parsing to the shared non-mutating Refund Sale 4 review with Ibuprofen x1, previously adjusted 0, remaining 1 → 0, KES 18 money back, default Money only, stock +0, Cash reversal and original sale completed. Confirm Refund was not tapped; no Refund record, stock, money or queue mutation occurred. Protected variants are `refund sale 4`, `refund sale four`, `refund sale number 4` and `refund sale number four`; incomplete, medicine-shaped and Refund/Return `cell` forms remain rejected. Do not repeat 055-J. **MS2-LT-055-K/Direct Command 5 — Credit routing only is the only active owner case.** Voice `credit sale N` now resolves through the same priority router and persisted immutable-sale lookup to the existing non-mutating Credit review; confirmation remains outside this case. MS2.0 permanently uses Voice first → fast tap/action second → typing last, with typed/voice parity through shared deterministic routing. | No | Staged | 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme |
...
- **Owner live-test evidence:** Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-J/Direct Command 4 are owner-verified passed/frozen/protected; 055-J is the latest protected resume point**. The corrected 2026-08-03 voice-first evidence proves `refund sale number four` routed before medicine parsing to the shared non-mutating Refund Sale 4 review with Ibuprofen x1, previously adjusted 0, remaining 1 → 0, KES 18 money back, default Money only, stock +0, Cash reversal and original sale completed. Confirm Refund was not tapped; no Refund record, stock, money or queue mutation occurred. Protected variants are `refund sale 4`, `refund sale four`, `refund sale number 4` and `refund sale number four`; incomplete, medicine-shaped and Refund/Return `cell` forms remain rejected. Do not repeat 055-J. **MS2-LT-055-K/Direct Command 5 — Credit routing only is the only active owner case.** Voice `credit sale N` now resolves through the same priority router and persisted immutable-sale lookup to the existing non-mutating Credit review; confirmation remains outside this case. MS2.0 permanently uses Voice first → fast tap/action second → typing last, with typed/voice parity through shared deterministic routing.; source: 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme
- **PASS / PROTECTED confirmation:** Not applicable.
