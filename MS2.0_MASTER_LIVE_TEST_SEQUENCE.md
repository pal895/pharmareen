...
| 55 | Refunds, returns and credits | Record linked financial/stock adjustments without deleting original history, then validate approved status-card and direct-command improvements without replacing the tappable route. | 51–54 | Implemented — awaiting owner live test | Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-I/Direct Command 3 are owner-verified passed/frozen/protected; 055-I is the latest protected resume point**. The 2026-08-02 voice-first evidence proves corrected transcript `return sale 2` opened the shared Return review and one Confirm Return created exactly Return record #10 through the protected adjustment engine: Ibuprofen x1, KES 18 reversed against Cash, stock restored 15 → 16, reciprocal immutable Sale 2 links, remaining 0 and disabled fully-adjusted controls. The earlier phone transcript `return cell to` caused no mutation and remains a recognition observation; do not broaden `cell` to `sale`. Do not repeat 055-I. **MS2-LT-055-J/Direct Command 4 — Refund routing only is the only active owner case.** Its first attempt safely exposed a stale deployment; its second safely exposed that exact voice transcript `refund sale number four` was not accepted by the narrow grammar and fell through to an unconfirmed Sales card. The shared grammar now accepts only optional literal `number` plus numeric/spoken sale numbers before medicine parsing, while incomplete and `cell` Refund forms remain rejected. Restart only 055-J with a fresh sale; confirmation remains outside this case. MS2.0 permanently uses Voice first → fast tap/action second → typing last, with typed/voice parity through shared deterministic routing. | No | Staged | 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme |
...
- **Owner live-test evidence:** Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-I/Direct Command 3 are owner-verified passed/frozen/protected; 055-I is the latest protected resume point**. The 2026-08-02 voice-first evidence proves corrected transcript `return sale 2` opened the shared Return review and one Confirm Return created exactly Return record #10 through the protected adjustment engine: Ibuprofen x1, KES 18 reversed against Cash, stock restored 15 → 16, reciprocal immutable Sale 2 links, remaining 0 and disabled fully-adjusted controls. The earlier phone transcript `return cell to` caused no mutation and remains a recognition observation; do not broaden `cell` to `sale`. Do not repeat 055-I. **MS2-LT-055-J/Direct Command 4 — Refund routing only is the only active owner case.** Its first attempt safely exposed a stale deployment; its second safely exposed that exact voice transcript `refund sale number four` was not accepted by the narrow grammar and fell through to an unconfirmed Sales card. The shared grammar now accepts only optional literal `number` plus numeric/spoken sale numbers before medicine parsing, while incomplete and `cell` Refund forms remain rejected. Restart only 055-J with a fresh sale; confirmation remains outside this case. MS2.0 permanently uses Voice first → fast tap/action second → typing last, with typed/voice parity through shared deterministic routing.; source: 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme
- **PASS / PROTECTED confirmation:** Not applicable.
