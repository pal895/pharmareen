...
| 55 | Refunds, returns and credits | Record linked financial/stock adjustments without deleting original history, then validate approved status-card and direct-command improvements without replacing the tappable route. | 51–54 | Implemented — awaiting owner live test | Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-K/Direct Command 5 are owner-verified passed/frozen/protected; 055-K is the latest protected resume point**. The 2026-08-03 voice-first evidence proves `credit sale number one` routed before medicine parsing to the shared non-mutating Credit Sale 1 review with Ibuprofen x1, previously adjusted 0, remaining 1 → 0, KES 18 account credit, stock +0, no Cash refund and original sale completed. Confirm Credit was not tapped; no Credit record, stock, financial posting or queue mutation occurred. Exact numeric/spoken and optional-`number` Credit variants share typed/voice priority routing. Do not repeat 055-K. **MS2-LT-055-L/Direct Command 6 — Safe linked Undo is the only active owner case.** Voice `undo sale N` opens a non-mutating review; one explicit confirmation delegates to the existing idempotent TCE reversal root, keeps the original sale, restores stock once, queues one linked action and blocks adjusted or already-undone sales. MS2.0 permanently uses Voice first → fast tap/action second → typing last. | No | Staged | 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme |
...
- **Owner live-test evidence:** Original 055-A through 055-F and post-original 055-G through **MS2-LT-055-K/Direct Command 5 are owner-verified passed/frozen/protected; 055-K is the latest protected resume point**. The 2026-08-03 voice-first evidence proves `credit sale number one` routed before medicine parsing to the shared non-mutating Credit Sale 1 review with Ibuprofen x1, previously adjusted 0, remaining 1 → 0, KES 18 account credit, stock +0, no Cash refund and original sale completed. Confirm Credit was not tapped; no Credit record, stock, financial posting or queue mutation occurred. Exact numeric/spoken and optional-`number` Credit variants share typed/voice priority routing. Do not repeat 055-K. **MS2-LT-055-L/Direct Command 6 — Safe linked Undo is the only active owner case.** Voice `undo sale N` opens a non-mutating review; one explicit confirmation delegates to the existing idempotent TCE reversal root, keeps the original sale, restores stock once, queues one linked action and blocks adjusted or already-undone sales. MS2.0 permanently uses Voice first → fast tap/action second → typing last.; source: 2026-07-31 through 2026-08-03 owner screenshots; shared Sale Adjustment and Sale Direct Command verifiers; Production Sales Card; TCE; offline queue/sync; consistency gate; LATP ordered 055 programme
- **PASS / PROTECTED confirmation:** Not applicable.
